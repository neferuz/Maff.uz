...
# Priority: exact color match first, then model fallback
PHOTO_MAP = [
    # ===== Elen =====
    ...
    (('Неаполь ПГ B3', None), '2h1nq27n2oejjshepu01hom5mpmjdw1u.jpg'),
    
    # ===== Неаполь ПГ B5 =====
    (('Неаполь ПГ B5', None), '2h1nq27n2oejjshepu01hom5mpmjdw1u.jpg'),
    ...
    (('Венеция ПГ B3', 'белый'), 'l2s21af3ybv41jr3n48j60vj1ah8rbp9.jpg'),
    (('Венеция ПГ B3', 'кремовый'), 'l2s21af3ybv41jr3n48j60vj1ah8rbp9.jpg'),
    (('Венеция ПГ B3', None), 'l2s21af3ybv41jr3n48j60vj1ah8rbp9.jpg'),
    
    # ===== Венеция ПГ B4 =====
    (('Венеция ПГ B4', 'белый'), '0fg3rzn37qujzdhedjy6i3ytosyk4x30.jpg'),
    (('Венеция ПГ B4', None), '0fg3rzn37qujzdhedjy6i3ytosyk4x30.jpg'),
    
    # ===== Венеция ПГ B5 =====
    (('Венеция ПГ B5', 'белый'), 'qepl102zizup5kr0poshftxhu0c8wmvl.jpg'),
    (('Венеция ПГ B5', None), 'qepl102zizup5kr0poshftxhu0c8wmvl.jpg'),
    
    # ===== Венеция ПО B5 =====
    (('Венеция ПО B5', 'белый'), 'o2rwi3rvba7l5gysbf1cd69l63zs27zh.jpg'),
    (('Венеция ПО B5', None), 'o2rwi3rvba7l5gysbf1cd69l63zs27zh.jpg'),
    ...
    (('Турин ПГ B4', None), '47jyoz7ew91x4wihpac27cqmcivk2rrk.jpg'),
    ...
    # ===== Portika (by model name in product) =====
