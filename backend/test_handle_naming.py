...
# Copy get_base_model_name from products.py
def get_base_model_name(name: str) -> str:
    ...
    cleaned = cleaned.strip().strip(",;-\s#()")
    return cleaned

names = [
    "ATEN Д.Ручка Вид накладки Цилинд NBM",
    "AGATE Д.Ручка Вид накладки Цилинд NBM-PN/NBM",
    "AKIK Д.Ручка Вид накладки Цилинд NBM",
    "AKIK Д.Ручка Вид накладки поворот BBN",
    "Ручка раздельная BLADE TL BL-24 чёрный",
    "Ручка раздельная FLY SL BL-24 чёрный",
    "Ручка раздельная FLY SL BL-24 чёрный (цилин. мех)",
    "Ручка раздельная Columba LD80-1AB/GP-7 бронза/золото",
    "Ручки AGB 1367",
    "Ручки AGB 1593 Графит",
    "Ручки комплект AGB 928 MBN",
    "Agb 929 MBN Графит ручка с замком без сердечника",
    "Agb 929 MBN Графит ручка с механизмом и сердцевиной",
    "Agb 929 MBN Графит ручка с поворотным механизмом"
]
