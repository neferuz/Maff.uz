    ...
    <div className="min-h-screen flex flex-col lg:flex-row font-sans">
      ...
      <div className="w-full lg:w-7/12 bg-white dark:bg-[#0f172a] order-2 lg:order-1 flex justify-center lg:justify-end px-4 md:px-8 xl:px-12 py-8 md:py-12">
        <div className="w-full max-w-xl">
          <Link href="/catalog" className="inline-flex items-center gap-2 text-sm font-medium text-slate-500 hover:text-slate-900 dark:hover:text-white mb-8 transition-colors w-fit bg-slate-50 dark:bg-slate-800 px-4 py-2 rounded-full">
...
console.log('Fixed syntax and restored clean typography');
